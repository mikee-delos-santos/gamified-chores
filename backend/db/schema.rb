...
ActiveRecord::Schema[8.1].define(version: 2026_08_24_180001) do
  ...
  create_table "cash_out_requests", force: :cascade do |t|
    ...
    t.index ["child_profile_id"], name: "index_cash_out_requests_on_child_profile_id"
    t.index ["decided_by_id"], name: "index_cash_out_requests_on_decided_by_id"
  end
  ...
  create_table "chores", force: :cascade do |t|
    ...
    t.index ["proof_by_child_id"], name: "index_chores_on_proof_by_child_id"
  end
  ...
  create_table "families", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "name", null: false
    t.decimal "peso_per_coin", precision: 10, scale: 2, default: "2.5", null: false
    t.string "pin_digest"
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "cash_out_requests", "child_profiles"
  add_foreign_key "cash_out_requests", "users", column: "decided_by_id"
